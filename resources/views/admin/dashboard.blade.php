    ...
    <div class="container">
        <div class="d-flex mb-3 gap-5 pt-4 border-bottom mx-auto align-items-center justify-content-center">
            <div class="pb-3 {{ $type == 'posts' ? 'border-bottom border-black' : 'text-dark-emphasis' }}"
                ...
                <a href="{{ route('dashboard', ['type' => 'posts']) }}" class="nav-link">Posts</a>
            </div>
            <div class=" pb-3 {{ $type == 'users' ? 'border-bottom border-black' : 'text-dark-emphasis' }}"
                style="margin-bottom: -1px;">
                <a href="{{ route('dashboard', ['type' => 'users']) }}" class="nav-link">Users</a>
            </div>
            <div class=" pb-3 {{ $type == 'categories' ? 'border-bottom border-black' : 'text-dark-emphasis' }}"
                style="margin-bottom: -1px;">
                <a href="{{ route('dashboard', ['type' => 'categories']) }}" class="nav-link">Categories</a>
            </div>
        </div>
                                                            ...
                                                            <li>
                                                                <form class="m-0 d-flex align-items-center text-center"
                                                                    ...
                                                                    <button type="button" id="followBtn"
                                                                        ...
                                                                        {{ auth()->user()->isFollowing($post->user)? 'Unfollow user': 'Follow user' }}
                                                                    </button>
                                                                </form>
                                                            </li>
                                                            <li>
                                ...
                                <div class="col-3 d-flex align-items-center">
                                    ...
                                    @else
                                        ...
                                        <img src="https://picsum.photos/seed/picsum/200/300"
                                            style="height: 150px; width: 90%" alt="Placeholder Image">
                                    @endif
                                </div>
                            </div>
                        </div>
